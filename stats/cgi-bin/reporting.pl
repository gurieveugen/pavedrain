...
#		}
	...
	foreach my $pluginname (keys %{$PluginsLoaded{'AddHTMLMenuHeader'}})  {
		...
		print "<div style=\"color:#ffcc00;font-size:40px;font-weight:600;font-family:Georgia,Verdana, Arial, Helvetica, Sans-serif;\">\n";
		print "	Name of site here\n";
		print "</div>\n";
		print "<div style=\"font-family:Georgia,Verdana, Arial, Helvetica, Sans-serif;font-size:12px;color:#555555;padding-top:20px;\">\n";
		print "	<a href=\"$httpDomain\" target=\"_BLANK\" style=\"font-family:Georgia,Verdana, Arial, Helvetica, Sans-serif;font-size:12px;color:#555555;\">$wwwDomain</a><br /><br />\n";
		print "	<strong>SEARCH ENGINE MARKETING REPORT FROM ";
		print uc($MonthNumLib{$MonthsToShow[0]});

		print " $YearsToShow[0] TO ";
		print uc($MonthNumLib{$MonthsToShow[($iMonthsToShow-1)]});
		print " ";
		print $YearsToShow[($iMonthsToShow-1)];
		print "</strong><br />\n";
		print "	We have analysed your websites statistics and are pleased to inform you that: <br /><br />	\n";
		print "	Over the past $iMonthsToShow months, Search World has delivered <strong>$TotalVisits</strong>";
		print "	qualified visits to your web site.<br /><br />\n";
		print "	The graph below indicates how many visitors your web site has received ";
		print "	in any particular month.<br /><br />\n";
		print "</div>\n";
...
#				if ($ShowPagesStats =~ /X/i) { print "<td>".($rest_x?$rest_x:"&nbsp;")."</td>"; }
		...
		if ($ShowKeyphrasesStats) {
			...
			&tab_head("Keyphrases used on search engines",19,'keyphrases');
